...
def add_sidebar():
   ...
   st.sidebar.header("Adjust sliders to update measurements")
...
def add_predictions(input_data):
   ...
   st.write(
       "This app can assist medical professionals in making a diagnosis, but should not be used as a substitute for a professional diagnosis.", font_size = 25)
